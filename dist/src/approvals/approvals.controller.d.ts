import { ApprovalsService, type ApprovalStatus, type ApprovalCategory } from './approvals.service';
export declare class ApprovalsController {
    private readonly approvalsService;
    constructor(approvalsService: ApprovalsService);
    list(req: any, status: ApprovalStatus, category?: ApprovalCategory, search?: string, limit?: string): Promise<import("./approvals.service").ApprovalItem[]>;
    getDetails(req: any, approvalId: string): Promise<{
        id: string;
        status: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    approve(req: any, approvalId: string): Promise<{
        procedure: {
            id: string;
            title: string;
            code: string | null;
    ...
    reject(req: any, approvalId: string, body: {
